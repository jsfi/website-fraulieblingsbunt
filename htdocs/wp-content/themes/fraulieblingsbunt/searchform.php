...
<form role="search" method="get" class="search__form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<button type="submit" class="search__submit btn"><svg width="24" height="24"><use xlink:href="#icon-search" /></svg><span class="visuallyhidden"><?php echo _x( 'Search', 'submit button', 'twentysixteen' ); ?></span></button>
</form>
